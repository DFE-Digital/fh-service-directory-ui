...
public class ServiceDirectoryClientException : Exception
{
    ...
    public ServiceDirectoryClientException(HttpResponseMessage httpResponseMessage, string errorResponse)
